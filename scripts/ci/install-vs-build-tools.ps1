...
$env:PATH = "C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;C:\ProgramData\chocolatey\bin;C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise;C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\MSBuild\Current\Bin"
[Environment]::SetEnvironmentVariable("Path", $env:PATH, "Machine")
#choco install -y visualstudio2017community

# $installerArgs = @("--norestart", "--passive", "--wait", "--includeRecommended", "--add Microsoft.VisualStudio.Workload.VCTools")
# $installerBinary = "C:\vs_buildtools_16.exe"

# if ($IncludeWin81Sdk -eq $true) {
#     $installerArgs += "--add Microsoft.VisualStudio.Component.Windows81SDK"
# }

# Invoke-WebRequest "https://aka.ms/vs/16/release/vs_BuildTools.exe" -OutFile $installerBinary
